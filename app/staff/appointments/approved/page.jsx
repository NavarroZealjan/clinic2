...
export default function AppointmentsApprovedPage() {
  ...
  useEffect(() => {
    const filtered = appointments.filter(
      (apt) => apt.status === "approved" && apt.fullName.toLowerCase().includes(searchTerm.toLowerCase()),
    )
    ...
    <div className="min-h-screen bg-slate-50">
      <div className="bg-cyan-500 text-white px-6 py-4">
        <div className="flex items-center gap-3">
          ...
          <div className="text-sm">Home &gt; Appointment Approved</div>
        </div>
      </div>

      <div className="p-6">
        <h1 className="text-3xl font-bold mb-6">Appointment Approved</h1>
                    ...
                    <TableRow key={appointment.id}>
                      ...
                      <TableCell>
                        <div className="flex gap-2">
                          <Button
                            size="sm"
                            className="bg-yellow-500 hover:bg-yellow-600 h-8 w-8 p-0"
